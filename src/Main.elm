...
viewPick idx =
    div [ style "margin" "320px 320px auto" ]
        [ table []
            [ tr []
                [ td [ style "padding" "20px" ] [ textButton TapDice1 "1" ]
                , td [ style "padding" "20px" ] [ textButton TapDice2 "2" ]
                , td [ style "padding" "20px" ] [ textButton TapDice3 "3" ]
                ]
            , tr []
                [ td [ style "padding" "20px" ] [ textButton TapDice4 "4" ]
                , td [ style "padding" "20px" ] [ textButton TapDice5 "5" ]
                , td [ style "padding" "20px" ] [ textButton TapDice6 "6" ]
                ]
            , tr []
                [ td [] []
                , td [ style "padding" "20px" ] [ textButton TapDiceClear "X" ]
                , td [] []
                ]
            ]
        ]
